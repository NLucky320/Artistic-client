  ...
  return (
    <section className="py-8 mt-12 md:mt-[80px] text-black  bg-gradient-to-r from-[#F9F3F0] via-[#FCE7DC] to-[#F9F3F0]">
        ...
        <div className="py-6 md:py-0 md:px-6">
          ...
          <div className="space-y-4">
            ...
            <p className="flex items-center">
              ...
              <span>artistic@business.com</span>
            </p>
          </div>
        </div>
        <form
        ...
        >
          ...
          <button
            type="button"
            className="self-center px-8 py-3 text-lg rounded focus:ring hover:ring focus:ring-opacity-75 bg-primary text-white focus:dark:ring-violet-600 hover:dark:ring-violet-600"
          >
            Submit
          </button>
        </form>
