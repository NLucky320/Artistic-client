...
const AddCraftsItem = () => {
    ...
    const handleAddCraftItem = event => {
        ...
        const newCraftItem = { item_Name, subcategory_Name, short_description, price, rating, customization, processing_time, stockStatus, image, name, email };
    ...
    return (
        <div className="bg-[#F4F3F0] mt-12 md:mt-[80px] p-6 md:p-16 text-center">
            ...
            <div className='max-w-[700px] mx-auto'>
                     <h2 className="text-xl md:text-3xl font-extrabold pt-4">Add Art Item</h2>
...
<select className='input input-bordered w-full' name="subcategory_Name" >
...
<select className='input input-bordered w-full' name="customization" >
...
<select className='input input-bordered w-full' name="stockStatus" >
  ...
  <option value="Made to Order">Made to Order</option>
                ...
                <input type="submit" value="Add Art" className="btn btn-block bg-primary text-white" />
