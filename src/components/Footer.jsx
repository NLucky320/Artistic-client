...
const Footer = () => {
    return (
			...
			<footer className="px-4 divide-y text-black bg-gradient-to-r from-[#F9F3F0] from-10% via-[#FCE7DC] via-30% to-[#F9F3F0] to-90% mt-12 md:mt-[80px]">
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		...
		<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
			...
			<div className="space-y-3">
				<h3 className="tracking-wide uppercase dark:text-gray-900">Legal</h3>
				<ul className="space-y-1">
					<li>
			...
			<div className="space-y-3">
				...
				<ul className="space-y-1">
					...
					<li>
						<a rel="noopener noreferrer" href="/contactUs">Contact</a>
					</li>
				</ul>
			</div>
			<div className="space-y-3 ">
				...
				<div className="flex justify-start space-x-3">
					<a rel="noopener noreferrer" href="https://facebook.com" title="Facebook" className="flex items-center p-1">
